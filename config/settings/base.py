...
MIGRATION_MODULES = {
    'sites': 'network_ui.contrib.sites.migrations'
}
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = 'network_ui.users.adapters.AccountAdapter'
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = 'network_ui.users.adapters.SocialAccountAdapter'
