# Generated by Django 2.0.8 on 2018-08-24 17:31
...
def forwards_func(apps, schema_editor):
    ...
    Device = apps.get_model("network_ui_dev", "Device")
    Device.objects.get_or_create(name="Unknown", device_id=-1, x=0, y=0, device_type="unknown", id=-1, topology_id=-1)
    Interface = apps.get_model("network_ui_dev", "Interface")
    Interface.objects.get_or_create(name="Unknown", device_id=-1, interface_id=-1, id=-1)



def add_load_test_case(apps, schema_editor):

    TestCase = apps.get_model('network_ui_dev', 'TestCase')
...
def populate_message_types(apps, schema_editor):
    ...
    MessageType = apps.get_model('network_ui_dev', 'MessageType')
...
def populate_result_types(apps, schema_editor):
    ...
    Result = apps.get_model('network_ui_dev', 'Result')
